...
def run_main_s(args):
    ...
    short_directory = r"bess_optimization/approximation"
...
def run_main_l(args):
    ...
    short_directory = r"bess_optimization/simulation"
    subprocess.run(['python', os.path.join(short_directory, 'main.py')] + filtered_args)
