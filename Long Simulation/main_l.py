...
from configuration_l import pop_size, soc_0, time_window, plot
from BESS_model_l import charge_rate_interpolated_func, discharge_rate_interpolated_func, size, charge_rate, \
    discharge_rate, technology, BESS_model
from Economic_parameters_l import PUN_timeseries
from Optimizer_l import Optimizer
from argparser_l import output_json_path, range_str, soc_min, power_energy, POD_power
...
class Main:
    ...
    def apply_physical_constraints(c_d_timeseries):
        ...
        for index in range(time_window - 1):
            ...
            from argparser_l import soc_max
