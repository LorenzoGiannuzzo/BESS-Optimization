...
class Revenues(ElementwiseProblem):
    def __init__(
        ...
        self.PUN_timeseries_sell = Economic_parameters_l.PUN_timeseries_sell[:, 1]
        self.PUN_timeseries_buy = Economic_parameters_l.PUN_timeseries_buy[:, 1]
        ...
        self.soc = np.array([configuration_l.soc_0] * (len(self.PUN_timeseries_sell)))
